...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6433320173:AAE6q34VE5peScZDaJ39wrGrn8lxGAOkXR8")

#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "22816865"))

#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "06f00fff8034f4878fdee8b29adaf718")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\n if u have bot link u can get videos here check out  https://t.me/all_medical_videos_cjs for links.")
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6597405776").split()):
        ADMINS.append(int(x))
except ValueError:
